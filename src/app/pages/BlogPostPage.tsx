  ...
  return (
    <div className="prose-dark space-y-8 pt-10">
      <ArticleParagraph>
        ...
        India's CERT-In SBOM Technical Guidelines (v2.0, July 2025) go beyond just SBOMsthey
      ...
      <ArticleParagraph>
        ...
        Even SBOMs produced by industry-standard tools like the CycloneDX Maven Plugincomplete with hundreds
        of components, accurate dependency graphs, and valid formatsscored around{' '}
      ...
      <ArticleParagraph>
        India isn't alone in demanding SBOM qualityit's just the most prescriptive so far:
      </ArticleParagraph>
